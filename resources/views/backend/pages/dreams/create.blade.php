            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('dreams.index')}}" class="btn btn-success btn-sm mb-3">Dreams
                            list</a>
                            ...
                            <div class="tab-content mb-3">
                                @foreach($languages as $key => $language)
                                    <div id="{{$language}}"
                                        ...
                                        <input type="text" name="name:{{$language}}" class="form-control mb-3"
                                        ...
                                        <input type="text" name="description:{{$language}}" class="form-control mb-3"
                                               value='{{old("description:$language")}}'>
                                        ...
                                        <textarea name="text:{{$language}}" id="text_{{$language}}" rows="4" cols="3"
                                                  class="form-control mb-3">{{old("text:$language")}} </textarea>
                                        @error("text:$language")
                                        <p class="text-danger mb-1">{{ $message }}</p>
                                        @enderror
                                    </div>
